...
1. 把 `eagle-cloud` 仓库发布到内部 Git 服务（**GitHub / GitLab / Gitee / Gitea** 均可）
2. 在 Claude Code 会话中运行：
...
```
/plugin marketplace add /path/to/eagle-cloud
/plugin install eagle-cloud@eagle-cloud
```
...
|-----------|-------------------|-------------|------|
| 1.0.0     | 当前主干（2026-04-30）  | 4.0.6       | 初始版本 |
