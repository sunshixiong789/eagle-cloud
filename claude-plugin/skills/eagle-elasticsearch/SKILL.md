---
name: eagle-elasticsearch
description: Use when working with Elasticsearch in eagle-cloud projects — full-text search, EsQueryBuilder fluent API, BaseElasticSearchRepository, highlighting, aggregations, EagleDocument base
---
