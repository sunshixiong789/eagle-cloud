---
name: eagle-row-security
description: Use when implementing row-level data permissions in eagle-cloud projects — @DataPermission(deptField, userField), DataScope enum (ALL/SELF/DEPT/DEPT_AND_CHILD/CUSTOM), DataPermissionProvider business implementation, JPA Specification injection
---
