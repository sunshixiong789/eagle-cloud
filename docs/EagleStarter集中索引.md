...
| `.claude/rules/04-data.md`         | `eagle-data-jpa-starter` / `eagle-mybatis-starter` / `eagle-data-r2dbc-starter` |
| `.claude/rules/05-security.md`     | `eagle-resource-server-starter` / `eagle-tenant-starter` / `eagle-row-security-starter` |
