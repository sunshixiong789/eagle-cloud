 ...
 * <p>
 * exchange {@code eagle_auth_events},routing key {@code account.deleted}。
 ...
 * 严格一致,故意<em>不</em>拼 {@code eagle.amqp.exchange-prefix}。
 */
@Slf4j
@Component
public class AccountDeletedConsumer extends AbstractAmqpListener<AccountDeletedMessage> {
    ...
    public AccountDeletedConsumer(AmqpProperties props,
