...
import com.eagle.auth.interfaces.dto.request.BindPhoneRequest;
import com.eagle.auth.interfaces.dto.request.ChangePasswordRequest;
import com.eagle.auth.interfaces.dto.request.CreateAccountRequest;
import com.eagle.auth.interfaces.dto.request.FreezeAccountRequest;
import com.eagle.auth.interfaces.dto.request.RegisterAccountRequest;
import com.eagle.auth.interfaces.dto.request.ResetPasswordRequest;
...
public class AccountController {
    ...
    private final com.eagle.auth.infrastructure.security.BlacklistChecker blacklistChecker;
    ...
    public Map<String, Long> register(@Valid @RequestBody RegisterAccountRequest request) {
        blacklistChecker.checkRegister(request.getPhone(), request.getEmail(),
                com.eagle.auth.infrastructure.security.ClientIpHolder.get());
