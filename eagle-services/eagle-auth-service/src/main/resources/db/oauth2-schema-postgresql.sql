-- ============================================================================
-- Spring Authorization Server 7.0.5 — PostgreSQL schema
--
-- 来源：spring-security-oauth2-authorization-server-7.0.5.jar 内的
--   org/springframework/security/oauth2/server/authorization/oauth2-authorization-schema.sql
--   org/springframework/security/oauth2/server/authorization/oauth2-authorization-consent-schema.sql
-- 按 Spring 官方注释适配 PostgreSQL：blob → text、timestamp → timestamptz。
--
-- 服务于 SecurityConfig 中显式装配的：
--   JdbcOAuth2AuthorizationService、JdbcOAuth2AuthorizationConsentService
-- RegisteredClient 由项目自定义的 JpaRegisteredClientRepository 处理（JPA），
-- 因此本文件不包含 oauth2_registered_client 表。
--
-- 通过 spring.sql.init 在应用启动时执行；使用 IF NOT EXISTS 保证幂等。
-- ============================================================================
