...
/**
 * DDD 分层约束验证(ArchUnit)—— auth-service 侧。
 * <p>
 * 与 system-service 的同名测试保持同一套规则:两个服务的分层标准必须一致,
 * 否则规则只在一边生效,另一边会悄悄腐化。改规则时两个文件要一起改。
 *
 * <p>与 {@link ModulithArchitectureTest} 的分工:
 * <ul>
 *   <li>Modulith 验证模块 <b>之间</b> 的边界(auth.core 声明 allowedDependencies = {})</li>
 ...
 *
 * <p><strong>运行</strong>
 * <pre>gradle :eagle-services:eagle-auth-service:test --tests "*LayeredArchitectureTest"</pre>
 */
