---
name: eagle-oss-minio
description: Use when implementing object storage (MinIO/local) in eagle-cloud projects — StorageService interface (upload/download/delete/getUrl), bucket/object key design, file upload validation
---
