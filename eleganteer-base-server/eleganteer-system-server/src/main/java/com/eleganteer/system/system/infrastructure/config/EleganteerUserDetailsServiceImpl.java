package com.eleganteer.system.system.infrastructure.config;

import com.eleganteer.eleganteer.common.dto.EleganteerUser;
import com.eleganteer.eleganteer.system.domain.model.Dept;
import com.eleganteer.eleganteer.system.domain.model.Role;
import com.eleganteer.eleganteer.system.domain.model.User;
import com.eleganteer.eleganteer.system.domain.repository.DeptRepository;
import com.eleganteer.eleganteer.system.domain.repository.RoleRepository;
...
public class EleganteerUserDetailsServiceImpl implements UserDetailsService {
    ...
    public @NonNull UserDetails loadUserByUsername(@NonNull String username) throws UsernameNotFoundException {
        ...
        if ("admin".equals(username)) {
            return new EleganteerUser(2121L, "admin", new BCryptPasswordEncoder().encode("123456"),
